        ...
        <section id="slider" class="slider-parallax swiper_wrapper full-screen clearfix">
            ...
            <div class="swiper-container swiper-parent">
                <div class="swiper-wrapper">
                    <div class="swiper-slide dark" style="background-image: url('images/alhuda/underconstruction.jpg');">
                        <div class="container clearfix">
                            <div class="slider-caption slider-caption-center">
                                <h2 data-caption-animate="fadeInUp">Welcome to Al-Huda Sunday School</h2>
...
if you need to register your child for the next term.)</span></p>
							...
							<div class="col-sm-4 bottommargin">
								<h2>Fee Schedule</h2>
								<p>Tuition fees, in full, must accompany the application for registration. Application forms must be fully completed
and signed by parent / guardian.</p>
				...
				<div id="section-works" class="page-section notoppadding notoppadding">
					...
					<div class="section blue nomargin">
						...
						<div class="row topmargin-lg divcenter" >
							...
							<div class="col-sm-4 bottommargin ss-announcements">
								...
								<p>Have been teaching Quranic Tafseer for over 25 years at various Islamic Schools including Islamic Foundation (15 years). Have been a student of Shaikh Mohammad Amin
								Always striving to impart to the students a sense of the ‘Spiritual’ and a deeper understanding of their own humanity and a realization of their relationship with Allah (swt)..</p>
							</div>
